        ...
        <div className="vintage-frame">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="grid md:grid-cols-3 gap-12 mb-16">
                    <div>
                        {posterUrl && (
                            <img src={posterUrl} alt={series.name} className="w-full border-4 border-gray-800" />
                        )}
                        ...
                        <div className="mt-4 bg-yellow-500 border-4 border-gray-800 p-6 text-center flex flex-col justify-center" style={{ minHeight: '240px' }}>
                            ...
                            <p className="text-xs font-serif text-gray-700 mt-4">{series.vote_count.toLocaleString()} votes</p>
                        </div>
                    </div>
